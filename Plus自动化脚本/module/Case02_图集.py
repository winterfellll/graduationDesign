...
class test(unittest.TestCase):
    ...
    def test_10(self):
        ...
        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/main/div/div/div/div[2]/div/div')
        self.plus.fc('body > div.modal.fade.ng-isolate-scope.upload_atlas.in > div > div > div > div.modal-body > div.content > div > div.upload-audio.ng-scope > div > input[type=file]').send_keys(picture_path)
        sleep(3)
        self.plus.fc('body > div.modal.fade.ng-isolate-scope.upload_atlas.in > div > div > div > div.modal-body > div.content > div > div > div > div:nth-child(1)').click()
        self.plus.fc('body > div.modal.fade.ng-isolate-scope.upload_atlas.in > div > div > div > div.modal-footer > button.btn.primary-btn').click()  # 确认
    ...
    def test_11(self):
        ...
        sleep(3)
        self.plus.fc('body > div.modal.fade.ng-isolate-scope.cover-imgModel.in > div > div > div > div.modal-body > div:nth-child(1) > ul > li:nth-child(3) > span').click()  # 资源库
        ...
        sleep(2)
        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/main/div/aside[1]/div/content-attr/div/div[2]/div[2]/div/div/div/div[8]')  # 裁剪按钮
        sleep(2)
        ...
        # sleep(2)
        # flag = len(self.plus.finds('/html/body/div[1]/div[2]/div[3]/ui-view/div/main/div/aside[1]/div/content-attr/div/div[3]/div/div/div[5]/div[12]'))
        # if flag:
        ...
        self.plus.send_key('//*[@id="journalist"]', 'journalist')
        self.plus.send_key('//*[@id="camera"]', 'camera')
        self.plus.send_key('//*[@id="source"]', 'source')
        self.plus.send_key('//*[@id="originalLink"]', 'https://baidu.com')
        sleep(2)

        # self.assertEqual(flag, 1, '编辑页面主题色无法使用')
    ...
    def test_12(self):
        ...
        ac(self.plus.driver).move_to_element(self.plus.find('/html/body/div[1]/div[2]/div[3]/ui-view/div/main/div/aside[2]/div/div/div[1]/content-relevant/div/div[2]/div/div[2]/img')).perform()
        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/main/div/aside[2]/div/div/div[1]/content-relevant/div/div[2]/div/div[2]/i')
    ...
    def test_13(self):
        '''新增图集内部功能验证F'''
        ac(self.plus.driver).move_to_element(self.plus.find('/html/body/div[1]/div[2]/div[3]/ui-view/div/main/div/div/div/div[2]/div/div[2]/div[2]/div/div/div/div[1]/img')).perform()
        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/main/div/div/div/div[2]/div/div[2]/div[2]/div/div[1]/div/div[2]')
        sleep(2)
        self.plus.click("//span[.='编辑']")  # 编辑
        sleep(3)
        length1 = len(self.plus.driver.find_elements(By.CSS_SELECTOR, '#avpw_canvas_embed'))
        if length1 != 0:
            style = self.plus.fc('#avpw_canvas_embed').get_attribute('style')
            if style == 'display: block;':
                sleep(2)
                self.plus.fc('#avpw_control_cancel_pane_inner > .avpw_close_inner').click()
                sleep(1)
            self.assertEqual(style, 'display: block;', '图片的编辑按钮失效')  # 判断编辑页面是否展开

        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/main/div/div/div/div[2]/div/div[1]/div/div/div/label/input')  # 全选
        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/main/div/div/div/div[2]/div/div[1]/button')  # 上传图片
        sleep(3)
        self.plus.fc('body > div.modal.fade.ng-isolate-scope.upload_atlas.in > div > div > div > div.modal-footer > button.btn.cancel-btn').click()

        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/main/div/div/div/content-save/div/div/div/button[1]')  # 预览
        sleep(3)
        length2 = len(self.plus.driver.find_elements(By.CSS_SELECTOR, "[ng-click='vm.goCopy()']"))
        self.plus.fc('body > div.modal.fade.ng-isolate-scope.showPreviews.in > div > div > div > div.modal-header > div.close > span').click()
        sleep(2)
        ...
        self.assertEqual(length2, 1, '预览功能失效')
        self.assertNotEqual(length1, 0, '新增页面图片的编辑功能失效')
    ...
    def test_14(self):
        ...
        self.plus.click(base.more_button10 + '/div/div/div/button[2]')  # 编辑
        sleep(5)
        self.plus.fc('.attrChange').send_keys('1')
        sleep(2)
        self.plus.fc('#vm\.atlasId > div > div > div > button.btn.primary-btn.save-btn.ng-isolate-scope').click()  # 保存
        sleep(5)
        ...
        self.plus.click(base.more_button10)
        self.plus.click(base.more_button10 + '/div/div/div/button[3]')  # 预览链接
        sleep(2)
        ...
        self.plus.click(base.more_button10)
        self.plus.click(base.more_button10 + '/div/div/div/button[4]')  # 预览
        sleep(5)
        flag = 1
        for i in range(10):
        ...
        self.plus.click(base.more_button10)
        self.plus.click(base.more_button10 + '/div/div/div/button[6]')  # 操作记录
        sleep(2)
        ...
        sleep(2)
        self.plus.fc(
            'body > div.modal.fade.ng-isolate-scope.content-time-modal.in > div > div > div > div:nth-child(2) > div.column-wrap > div.column_content.ng-isolate-scope > ks-swiper-container > div > div.swiper-wrapper > div.swiper-slide.list_box.swiper-slide-active > div > div:nth-child(2) > input[type=checkbox]').click()
        self.plus.find('/html/body/div[5]/div/div/div/div[3]/div[2]/div/div/div/div/div[2]/input').clear()
        self.plus.find('/html/body/div[5]/div/div/div/div[3]/div[2]/div/div/div/div/div[2]/input').send_keys((datetime.datetime.now() + datetime.timedelta(minutes=5)).strftime("%H:%M"))
        sleep(2)
        ...
        self.plus.click(base.more_button10)
        self.plus.click(base.more_button10 + '/div/div/div/button[13]')  # 审核
        sleep(4)
        text6 = self.plus.find(base.status).text

        text7 = self.plus.find(base.status).text
        self.plus.click(base.more_button10)
        self.plus.click(base.more_button10 + '/div/div/div/button[12]')  # 打回
        sleep(2)
        ...
        self.plus.click(base.more_button10)
        self.plus.click(base.more_button10 + '/div/div/div/button[13]')  # 删除
    ...
    def test_15(self):
        ...
        self.plus.fc('body > div.modal.fade.ng-isolate-scope.upload_atlas.in > div > div > div > div.modal-body > div.content > div > div.upload-audio.ng-scope > div > input[type=file]').send_keys(picture_path)
        sleep(3)
        self.plus.fc('body > div.modal.fade.ng-isolate-scope.upload_atlas.in > div > div > div > div.modal-body > div.content > div > div > div > div:nth-child(1) > img').click()
        self.plus.fc('body > div.modal.fade.ng-isolate-scope.upload_atlas.in > div > div > div > div.modal-footer > button.btn.primary-btn').click()
        sleep(2)
        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/main/div/div/div/content-save/div/div/div/button[2]')  # 保存
        sleep(5)
