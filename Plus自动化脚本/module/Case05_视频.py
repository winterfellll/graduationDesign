...
class test(unittest.TestCase):
    ...
    def test_11(self):
        ...
        sleep(2)
        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/main/div/aside[1]/div/content-attr/div/div[2]/div[2]/div/div/div/div[1]')  # 封面图
        sleep(3)
        ...
        self.plus.fc('.ui-switch > span:nth-of-type(1)').click()  # 评论
    ...
    def test_13(self):
        ...
        self.assertEqual(length2, 0, '新增页面预览功能失效')
    ...
    def test_14(self):
        ...
        self.plus.click(base.more_button11 + '/div/div/div/button[4]')  # 编辑
        sleep(5)
        ...
        self.plus.click(base.more_button11)
        self.plus.click(base.more_button11 + '/div/div/div/button[6]')  # 预览链接
        sleep(2)
        ...
        self.plus.click(base.more_button11)
        self.plus.click(base.more_button11 + '/div/div/div/button[9]')  # 操作记录
        sleep(2)
        ...
        sleep(2)
        length1 = len(self.plus.finds(base.shipin_lanmu + '/span[2]'))

        text5 = self.plus.find(base.status).text
        self.plus.click(base.more_button11)
        self.plus.click(base.more_button11 + '/div/div/div/button[16]')  # 审核
        sleep(3)
        text6 = self.plus.find(base.status).text

        text7 = self.plus.find(base.status).text
        self.plus.click(base.more_button11)
        self.plus.click(base.more_button11 + '/div/div/div/button[15]')  # 打回
        sleep(2)
        self.plus.fc('body > div.modal.fade.ng-isolate-scope.conformModal.in > div > div > div > div > div.modal-footer > button.btn.btn-sure.p-x-md.ng-binding').click()
        sleep(5)
        ...
        self.plus.click(base.more_button11)
        self.plus.click(base.more_button11 + '/div/div/div/button[16]')  # 删除
    ...
    def test_15(self):
        ...
        file1 = len([lists for lists in os.listdir(path) if os.path.isfile(os.path.join(path, lists))])
        self.plus.click(base.more_button11)
        self.plus.click(base.more_button11 + '/div/div/div/button[2]')  # 下载
        sleep(2)
    ...
    def test_16(self):
        '''更多-预览按钮验证F'''
        self.plus.click(base.more_button11)
        self.plus.click(base.more_button11 + '/div/div/div/button[7]')  # 预览
        sleep(5)
    ...
    def test_18(self):
        ...
        sleep(3)
        length = len(self.plus.finds(base.shipin_lanmu + '/span/a'))
    ...
    def test_19(self):
        ...
        sleep(2)
        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/div[1]/div[2]/div/div/div/div[2]/div/div[3]/div[1]/div[1]/div[1]/label/input')
        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/div[1]/div[2]/div/div/div/div[2]/div/div[3]/div[11]/div[2]/div/button[12]')  # 选择栏目
        sleep(2)
        ...
        ac(self.plus.driver).scroll_by_amount(0, -500).perform()
        sleep(2)
        text1 = self.plus.find(base.shipin_lanmu + '/span/a').text

        ac(self.plus.driver).scroll_by_amount(0, -500).perform()
        sleep(2)
        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/div[1]/div[2]/div/div/div/div[2]/div/div[3]/div[1]/div[1]/div[1]/label/input')
        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/div[1]/div[2]/div/div/div/div[2]/div/div[3]/div[11]/div[2]/div/button[11]')  # 提审
        sleep(4)
        ...
        sleep(2)
        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/div[1]/div[2]/div/div/div/div[2]/div/div[3]/div[1]/div[1]/div[1]/label/input')
        self.plus.click('/html/body/div[1]/div[2]/div[3]/ui-view/div/div[1]/div[2]/div/div/div/div[2]/div/div[3]/div[11]/div[2]/div/button[13]')  # 设置标签
        sleep(2)
        ...
        sleep(2)
        length = len(self.plus.finds(base.shipin_lanmu + '/div[1]/span'))
